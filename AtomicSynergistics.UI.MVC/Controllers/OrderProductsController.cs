...
namespace AtomicSynergistics.UI.MVC.Controllers
{
    ...
    public class OrderProductsController : Controller
    {
        ...
        public OrderProductsController(AtomicContext context)
        {
            _context = context;
        }
        ...
        {
            var atomicContext = _context.OrderProducts.Include(o => o.Order).Include(o => o.Product);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AtomicContext.OrderProducts'  is null.");
            }
            var orderProduct = await _context.OrderProducts.FindAsync(id);
            if (orderProduct != null)
            {
